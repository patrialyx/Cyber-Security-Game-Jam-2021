...
public class SelectorHandler1:MonoBehaviour
{
    [SerializeField]
    ...
    public void Start()
    {
        ...
        userSelectedList =  new int[] {0,0,0,0,0,0,0,0};
        modelAnswerList = new int[] {0,1,0,0,0,0,0,0};
        emptyArray = new int[] {0,0,0,0,0,0,0,0};
    }
